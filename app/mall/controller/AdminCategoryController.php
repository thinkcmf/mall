...
class AdminCategoryController extends AdminBaseController
{
    ...
    {
        $categories = CategoryService::getMallCategories();
    ...
    public function add()
    {
        ...
        //分类树状
        $categoriesTree = CategoryService::mallCategoryTree($parentId);
        //商品模型
    ...
    public function addPost()
    {
        ...
        $result = CategoryService::addCategory($param);
        if ($result) {
    ...
    public function edit()
    {
        ...
        $categoriesTree    = CategoryService::mallCategoryTree($category['parent_id'], $id);
        //商品模型
